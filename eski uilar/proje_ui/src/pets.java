...
public class pets extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            jTable1.getColumnModel().getColumn(0).setHeaderValue("Ad");
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Kategori");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Miktar");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Fiyat");
        }
